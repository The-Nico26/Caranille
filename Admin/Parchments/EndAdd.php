...
$parchmentImage = htmlspecialchars(addslashes($_POST['parchmentPicture']));
$parchmentType = 'Parchment';
...
addParchment($bdd, $parchmentPicture, $parchmentType, $parchmentLevel, $parchmentName, $parchmentDescription, $parchmentHP, $parchmentMP, $parchmentStrength, $parchmentMagic
