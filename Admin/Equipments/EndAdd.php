...
addequipment($bdd, $equipmentImage, $equipmentType, $equipmentLevel, $equipmentName, $equipmentDescription, $equipmentHP, $equipmentMP, $equipmentStrength, $equipmentMagic
